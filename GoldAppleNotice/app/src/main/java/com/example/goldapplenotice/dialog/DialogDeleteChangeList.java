...
public class DialogDeleteChangeList extends AlertDialog implements DialogInterface.OnClickListener{
    private Context context;
    private LinearLayout layoutWithProduct;
    private TextView emptyText;

    public DialogDeleteChangeList(Context context, LinearLayout layoutWithProduct, TextView emptyText) {
        super(context);
